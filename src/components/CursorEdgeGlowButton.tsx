...
const HUE_SHIFT = 0; // Set to 0 since we changed CSS to blue

export function CursorEdgeGlowButton({ text, href }: { text: string, href: string }) {
  ...
  return (
    <div ref={containerRef} className="edge-light-button">
      ...
      <a ref={buttonRef} href={href} className="edge-light-button__control">
