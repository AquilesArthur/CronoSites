  ...
  return (
    <section className="relative min-h-[100svh] flex items-center justify-center overflow-hidden pt-32 pb-16 md:pt-40 md:pb-24">
      ...
      <div className="container mx-auto px-6 relative z-10 max-w-5xl text-center">
        ...
        >
          <a href={getWhatsAppLink()} target="_blank" rel="noopener noreferrer" className="w-full sm:w-auto px-8 py-4 rounded-full bg-crono-dark text-white font-medium hover:bg-black transition-all hover:scale-105 active:scale-95 flex items-center justify-center gap-2 group shadow-[0_10px_30px_rgba(0,0,0,0.15)] text-[15px] md:text-base">
            Solicitar orçamento
