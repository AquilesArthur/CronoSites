        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-10 md:gap-12 border-b border-gray-100 pb-12 md:pb-16">
          ...
          <div>
            ...
            <ul className="space-y-3 md:space-y-4">
              ...
              <li>
                <a href={siteConfig.links.instagram} target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 text-gray-500 hover:text-crono-accent transition-colors">
